...
const AuthPage = ({ mode = "login", onClose }) => {
  ...
  return (
    <div
      onClick={onClose}
      className="fixed inset-0 z-50 flex h-screen w-full items-center justify-center bg-black/30 px-5 lg:px-10"
    >
      <div
        className=" w-full sm:w-9/10  lg:w-6/7 h-9/10 flex justify-center items-center rounded-2xl border-2 border-gray-400 relative"
        onClick={(e) => e.stopPropagation()}
      >
        <div className=" h-8 aspect-square flex justify-center items-center rounded-tr-2xl rounded-bl-2xl bg-gray-200 hover:bg-gray-300 absolute top-0 right-0 ">
